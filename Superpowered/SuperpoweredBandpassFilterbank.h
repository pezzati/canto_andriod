...
/**
 ...
 @param samplerate The initial sample rate.
*/
    SuperpoweredBandpassFilterbank(int numGroups, int numBandsInGroup, float *frequencies,
                                   float *widths, unsigned int samplerate);
 ...
 */
    void
    processNoAdd(float *input, float *bands, float *peak, float *sum, unsigned int numberOfSamples,
                 int group = 0);
