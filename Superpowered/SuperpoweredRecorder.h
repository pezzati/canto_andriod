...
public:
     ...
     */
    SuperpoweredRecorder(const char *tempPath, unsigned int samplerate, unsigned int minSeconds = 1,
                         unsigned char numChannels = 2, bool applyFade = false,
                         SuperpoweredRecorderStoppedCallback callback = NULL,
