 ...
 */
    void
    setResonantParametersAndType(float frequency, float resonance, SuperpoweredFilterType type);
 ...
 */
    void setShelfParametersAndType(float frequency, float slope, float dbGain,
                                   SuperpoweredFilterType type);
 ...
 */
    void setBandlimitedParametersAndType(float frequency, float octaveWidth,
                                         SuperpoweredFilterType type);
