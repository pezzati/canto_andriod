 ...
 */
typedef void (*SuperpoweredDecoderID3Callback)(void *clientData, void *frameName, void *frameData,
                                               int frameDataSize);
 ...
 */
typedef void (*SuperpoweredDecoderFullyDownloadedCallback)(void *clientData,
 ...
 */
    SuperpoweredDecoder(SuperpoweredDecoderFullyDownloadedCallback downloadedCallback = 0,
                        void *clientData = 0);
 ...
 */
    const char *open(const char *path, bool metaOnly = false, int offset = 0, int length = 0,
                     int stemsIndex = 0, char **customHTTPHeaders = 0, int *errorCode = 0);
 ...
 */
    unsigned char
    getAudioStartSample(unsigned int *startSample, unsigned int limitSamples = 0, int decibel = 0,
                        unsigned int *cancelIfBuffering = 0);
 ...
 */
    void getMetaData(char **artist, char **title, char **album, void **image, int *imageSizeBytes,
                     float *bpm, SuperpoweredDecoderID3Callback callback, void *clientData,
                     int maxFrameDataSize);
...
*/
    bool getStemsInfo(char *names[4] = 0, char *colors[4] = 0, stemsCompressor *compressor = 0,
                      stemsLimiter *limiter = 0);
