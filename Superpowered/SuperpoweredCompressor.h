...
// READ-WRITE parameters
    ...
    bool
    process(float *input, float *output, unsigned int numberOfSamples); // input is the sidechain
    bool process(float *input, float *sidechain, float *output,
                 unsigned int numberOfSamples); // separate sidechain
