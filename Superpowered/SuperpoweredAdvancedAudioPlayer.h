 ...
 */
typedef void (*SuperpoweredAdvancedAudioPlayerCallback)(void *clientData,
...
*/
    SuperpoweredAdvancedAudioPlayer(void *clientData,
                                    ...
                                    unsigned int sampleRate, unsigned char cachedPointCount,
 ...
 */
    void
    setPosition(double ms, bool andStop, bool synchronisedStart, bool forceDefaultQuantum = false,
...
/**
 ...
 @param preferWaitingforSynchronisedStart Wait or start immediately when synchronized.
 */
    bool loop(double startMs, double lengthMs, bool jumpToStartMs, unsigned char pointID,
              bool synchronisedStart, bool forceDefaultQuantum = false,
              bool preferWaitingforSynchronisedStart = false);
...
/**
 ...
 @param preferWaitingforSynchronisedStart Wait or start immediately when synchronized.
*/
    bool loopBetween(double startMs, double endMs, bool jumpToStartMs, unsigned char pointID,
                     bool synchronisedStart, bool forceDefaultQuantum = false,
                     bool preferWaitingforSynchronisedStart = false);
...
*/
    void jogTouchBegin(int ticksPerTurn, SuperpoweredAdvancedAudioPlayerJogMode mode,
                       unsigned int scratchSlipMs);
...
*/
    void jogTick(int value, bool bendStretch, float bendMaxPercent, unsigned int bendHoldMs,
                 bool parameterMode);
...
/**
 ...
 @param quantum Reserved for future use.
*/
    bool process(float *buffer, bool bufferAdd, unsigned int numberOfSamples, float volume = 1.0f,
                 double masterBpm = 0.0f, double masterMsElapsedSinceLastBeat = -1.0,
                 double phase = -1.0, double quantum = -1.0);
 ...
 */
    bool
    processMulti(float **buffers, bool *bufferAdds, unsigned int numberOfSamples, float *volumes,
                 double masterBpm = 0.0f, double masterMsElapsedSinceLastBeat = -1.0,
                 double phase = -1.0, double quantum = -1.0);
