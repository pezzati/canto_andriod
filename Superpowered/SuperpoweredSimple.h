 ...
 */
void SuperpoweredVolume(float *input, float *output, float volumeStart, float volumeEnd,
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredChangeVolume(float *input, float *output, float volumeStart, float volumeChange,
                              unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredVolumeAdd(float *input, float *output, float volumeStart, float volumeEnd,
                           unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredChangeVolumeAdd(float *input, float *output, float volumeStart, float volumeChange,
                                 unsigned int numberOfSamples);
 ...
 */
void SuperpoweredCharToFloat(signed char *input, float *output, unsigned int numberOfSamples,
...
/**
 ...
 @param numChannels The number of channels. One sample may be 1 value (1 channels) or N values (N channels).
 */
void SuperpoweredFloatToChar(float *input, signed char *output, unsigned int numberOfSamples,
                             unsigned int numChannels = 2);
...
/**
 ...
 @param numChannels The number of channels. One sample may be 1 value (1 channels) or N values (N channels).
 */
void Superpowered24bitToFloat(void *input, float *output, unsigned int numberOfSamples,
                              unsigned int numChannels = 2);
...
/**
 ...
 @param numChannels The number of channels. One sample may be 1 value (1 channels) or N values (N channels).
 */
void SuperpoweredFloatTo24bit(float *input, void *output, unsigned int numberOfSamples,
                              unsigned int numChannels = 2);
...
/**
 ...
 @param numChannels The number of channels. One sample may be 1 value (1 channels) or N values (N channels).
 */
void SuperpoweredIntToFloat(int *input, float *output, unsigned int numberOfSamples,
                            unsigned int numChannels = 2);
...
/**
 ...
 @param numChannels The number of channels. One sample may be 1 value (1 channels) or N values (N channels).
 */
void SuperpoweredFloatToInt(float *input, int *output, unsigned int numberOfSamples,
                            unsigned int numChannels = 2);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredFloatToShortIntInterleave(float *inputLeft, float *inputRight, short int *output,
                                           unsigned int numberOfSamples);
 ...
 */
void
SuperpoweredInterleaveAdd(float *left, float *right, float *output, unsigned int numberOfSamples);
...
/**
 ...
 @param peaks Peak value result (2 floats: left peak, right peak).
 */
void SuperpoweredInterleaveAndGetPeaks(float *left, float *right, float *output,
                                       unsigned int numberOfSamples, float *peaks);
 ...
 */
void
SuperpoweredDeInterleave(float *input, float *left, float *right, unsigned int numberOfSamples);
 ...
 */
void SuperpoweredDeInterleaveMultiply(float *input, float *left, float *right,
                                      unsigned int numberOfSamples, float multiplier);
 ...
 */
void
SuperpoweredDeInterleaveAdd(float *input, float *left, float *right, unsigned int numberOfSamples);
...
/**
 ...
 @param multiplier Multiply each output sample with this value.
 */
void SuperpoweredDeInterleaveMultiplyAdd(float *input, float *left, float *right,
                                         unsigned int numberOfSamples, float multiplier);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredStereoToMono(float *input, float *output, float leftGainStart, float leftGainEnd,
                              float rightGainStart, float rightGainEnd,
                              unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredStereoToMono2(float *input, float *output0, float *output1, float leftGainStart,
                               float leftGainEnd, float rightGainStart, float rightGainEnd,
                               unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredCrossMono(float *left, float *right, float *output, float leftGainStart,
                           float leftGainEnd, float rightGainStart, float rightGainEnd,
                           unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredCrossMono2(float *left, float *right, float *output0, float *output1,
                            float leftGainStart, float leftGainEnd, float rightGainStart,
                            float rightGainEnd, unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
void SuperpoweredCrossStereo(float *inputA, float *inputB, float *output, float gainStart[4],
                             float gainEnd[4], unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfValues The length of input.
 */
void SuperpoweredAdd4(float *inputA, float *inputB, float *inputC, float *inputD, float *output,
