 ...
 */
typedef void (*SuperpoweredUSBAudioDeviceConnectedCallback)(void *clientdata, int deviceID,
                                                            const char *manufacturer,
                                                            const char *product, const char *info);
...
/**
 ...
 @param product Product name.
 */
typedef void (*SuperpoweredUSBMIDIDeviceConnectedCallback)(void *clientdata, int deviceID,
                                                           const char *manufacturer,
                                                           const char *product);
...
public:
     ...
     */
    static void initialize(void *clientdata, SuperpoweredUSBAudioDeviceConnectedCallback c0,
                           SuperpoweredUSBAudioDeviceDisconnectedCallback c1,
                           SuperpoweredUSBMIDIDeviceConnectedCallback c2,
                           SuperpoweredUSBMIDIDeviceDisconnectedCallback c3);
 ...
 */
typedef bool (*SuperpoweredUSBAudioProcessingCallback)(void *clientdata, int deviceID,
                                                       float *audioIO, int numberOfSamples,
                                                       int samplerate, int numInputChannels,
...
public:
     ...
     */
    static void
    getInfo(int deviceID, const char **manufacturer, const char **product, const char **info);
     ...
     */
    static void
    getConfigurationInfo(int deviceID, int *numConfigurations, char ***configurationNames);
    ...
    */
     ...
     */
    static void getBestIO(int deviceID, int *inputIOindex, int *outputIOindex, int samplerate,
                          int bitsPerSample, int numInputChannels, int numOutputChannels,
                          bool strict);
     ...
     */
    static void getIOOptions(int deviceID, bool input, int IOindex, int **paths, char ***pathNames,
                             int *numPaths, int **thruPaths, char ***thruPathNames,
                             int *numThruPaths);
     ...
     */
    static void getPathInfo(int deviceID, int pathIndex, int *numFeatures, float **minVolumes,
                            float **maxVolumes, float **curVolumes, char **mutes);
     ...
     */
    static bool
    startIO(int deviceID, int inputIOindex, int outputIOindex, SuperpoweredUSBAudioLatency latency,
            void *clientdata, SuperpoweredUSBAudioProcessingCallback callback);
    ...
    /*
     ...
     @param callback The callback to be called periodically.
     */
    static bool easyIO(int deviceID, int samplerate, int bitsPerSample, int numInputChannels,
                       int numOutputChannels, SuperpoweredUSBAudioLatency latency, void *clientdata,
                       SuperpoweredUSBAudioProcessingCallback callback);
 ...
 */
typedef void (*SuperpoweredUSBMIDIReceivedCallback)(void *clientdata, int deviceID,
...
public:
     ...
     */
    static bool
    startIO(int deviceID, void *clientdata, SuperpoweredUSBMIDIReceivedCallback callback);
