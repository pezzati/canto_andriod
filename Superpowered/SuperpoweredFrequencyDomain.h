...
*/
    bool
    timeDomainToFrequencyDomain(float *magnitudeL, float *magnitudeR, float *phaseL, float *phaseR,
                                float valueOfPi = 0, bool complexMode = false,
...
/**
 ...
 @param complexMode Instead of polar transform, returns complex values (magnitude: real, phase: imag).
*/
    bool timeDomainToFrequencyDomain(float *magnitude, float *phase, float valueOfPi = 0,
...
*/
    void
    frequencyDomainToTimeDomain(float *magnitudeL, float *magnitudeR, float *phaseL, float *phaseR,
                                float *output, float valueOfPi = 0, int incrementSamples = 0,
                                bool complexMode = false, int stereoPairIndex = 0);
